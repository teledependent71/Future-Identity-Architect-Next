...
import authorsPageInitialProps80491Resource from '../../resources/authors-page-initial-props-80491'
  ...
  return (
    <>
      <div className="authors-container">
        <Head>
          <title>Authors - Future Identity Architect</title>
          <meta
            property="og:title"
            content="Authors - Future Identity Architect"
          />
        </Head>
        <DataProvider
...
export async function getStaticProps(context) {
  try {
    const response = await authorsPageInitialProps80491Resource({
      ...context?.params,
    })
    if (!response) {
      return {
